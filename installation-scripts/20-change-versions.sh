...
echo "What is the old version? e.g.   v4.5.0    (including v and dots)"
read oldversion

echo "To what version do you want upgrade e.g.    v4.5.1   (including v and dots)"

read newversion

echo "We well change all old instances i.e. "$oldversion" to this version: "$newversion
